...
-- Выполненные CRUD операции в консоли на БД VK
...
USE vk3;
SHOW TABLES;
SELECT * FROM communities;-- Таблица групп
SELECT * FROM communities_users;-- Таблица связи пользователей и групп
SELECT * FROM friendship_statuses;-- Таблица статусов дружеских отношений
SELECT * FROM friendships;-- Таблица дружбы
SELECT * FROM media;-- Таблица медиафайлов
SELECT * FROM media_types;-- Таблица типов медиафайлов
SELECT * FROM messages;-- Таблица сообщений
SELECT * FROM profiles;-- Таблица профилей
SELECT * FROM users;
