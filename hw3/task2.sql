...
CREATE TABLE media_likes (
  media_id INT UNSIGNED NOT NULL COMMENT "Ссылка на медиа, которое лайкнули",
  liked_by INT UNSIGNED NOT NULL COMMENT "Ссылка на лайкнувшего пользователя",  
  PRIMARY KEY (media_id, liked_by) COMMENT "Составной первичный ключ",
  created_at DATETIME DEFAULT NOW() COMMENT "Время создания записи"
) COMMENT "Лайки медиа";

-- Таблица лайков пользователей
CREATE TABLE user_likes (
  user_id INT UNSIGNED NOT NULL COMMENT "Ссылка на пользователя, которого лайкнули",
  liked_by INT UNSIGNED NOT NULL COMMENT "Ссылка на лайкнувшего пользователя",  
  PRIMARY KEY (user_id, liked_by) COMMENT "Составной первичный ключ",
  created_at DATETIME DEFAULT NOW() COMMENT "Время создания записи"
